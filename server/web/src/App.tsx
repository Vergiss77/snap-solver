    ...
    <div className="app">
      ...
      {showConfig ? (
        ...
        <div className="content">
          <HistoryList sessions={sessions} selectedId={viewing} onSelect={(id) => setSelectedId(id)} />
          {viewingSummary ? (
            <SessionView session={viewingSummary} detail={detail?.id === viewingSummary.id ? detail : null} />
          ) : (
